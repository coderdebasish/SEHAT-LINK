  ...
  return (
    <div className="dashboard-layout">
      ...
      <div className="dashboard-main">
        <Topbar title="Clinical Consultation Notes (SOAP)" subtitle="Physician Evaluation History &amp; ICD-10 Records" profile={auth.profile} onSignOut={auth.signOut} />
            ...
            <form onSubmit={handleCreateConsultation} className="space-y-3 text-xs">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="form-group">
                  ...
                  <select className="input font-mono font-bold" value={icd10} onChange={e => setIcd10(e.target.value)}>
